...
class YiyanWidget {
  ...
  async render() {
    ...
    return /* @__PURE__ */ h("wbox", null, /* @__PURE__ */ h("wstack", {
    ...
    }, "一言")), /* @__PURE__ */ h("wspacer", null), /* @__PURE__ */ h("wtext", {
      font: Font.lightSystemFont(16),
      onClick: () => this.menu()
    }, hitokoto), /* @__PURE__ */ h("wspacer", null), /* @__PURE__ */ h("wtext", {
