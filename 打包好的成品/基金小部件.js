...
var {setStorage: setStorage2, getStorage: getStorage2} = useStorage('Funds')
var transparentBg = getStorage2('transparentBg') || '#fff'
var textColor = getStorage2('textColor') || (transparentBg === '#fff' ? '#000' : '#fff')
var bgColor = getStorage2('bgColor') || '#ffffff00'
var fundsCode = getStorage2('fundsCode') || []
